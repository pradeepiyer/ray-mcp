...
These tests actually start Ray clusters and test complete workflows.
They are intentionally minimal and focused on critical user journeys.
"""
...
class TestE2EIntegration:
    """Essential end-to-end tests for critical Ray workflows."""
