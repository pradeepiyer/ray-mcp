...
from .interfaces import ClusterManager, JobManager, LogManager, PortManager, StateManager
...
class RayUnifiedManager:
    ...
    def __init__(self):
        ...
        self._state_manager: StateManager = RayStateManager()
        self._port_manager: PortManager = RayPortManager()
        
        # Initialize specialized managers with dependencies
        self._cluster_manager: ClusterManager = RayClusterManager(
            self._state_manager, 
            self._port_manager
        )
        self._job_manager: JobManager = RayJobManager(self._state_manager)
        self._log_manager: LogManager = RayLogManager(self._state_manager)
